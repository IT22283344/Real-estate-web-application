    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex items-center gap-2">
            <input type="number" id="discountedprice" min='1' max='10' className="p-3 border border-gray-300 rounded-lg"/>
            <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col flex-1 gap-4 pl-6">
          ...
          <button className="p-3 bg-slate-700 text-white border  rounded-lg uppercase hover:opacity-90 disabled:opacity-80">Create Listing</button>
        </div>
      </form>
    </main>
  );
