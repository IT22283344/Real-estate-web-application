    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4 pl-6">
          ...
          {formData.imageUrls.length > 0 &&
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                />
                <button
                  className="uppercase text-red-500 p-3 hover:opacity-75"
                  type="button"
          ...
          <button disabled={loading || uploading} className="p-3 bg-slate-700 text-white border  rounded-lg uppercase hover:opacity-90 disabled:opacity-80">
